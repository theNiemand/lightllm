# Adapted from
# https://github.com/vllm-project/vllm/blob/v0.6.3.post1/vllm/platforms/cuda.py
...
def device_id_to_physical_device_id(device_id: int) -> int:
    if "CUDA_VISIBLE_DEVICES" in os.environ:
        ...
        if device_ids == [""]:
            raise RuntimeError("CUDA_VISIBLE_DEVICES is set to empty string," " which means GPU support is disabled.")
