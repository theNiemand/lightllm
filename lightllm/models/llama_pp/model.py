...
import json
import torch
from lightllm.models.llama_pp.layer_infer.pre_layer_infer import LlamaPpPreLayerInfer
from lightllm.models.llama_pp.layer_infer.post_layer_infer import LlamaPpPostLayerInfer
from lightllm.models.llama_pp.layer_infer.transformer_layer_infer import LlamaPpTransformerLayerInfer
from lightllm.models.llama_pp.layer_weights.pre_and_post_layer_weight import LlamaPpPreAndPostLayerWeight
from lightllm.models.llama_pp.layer_weights.transformer_layer_weight import LlamaPpTransformerLayerWeight
from lightllm.models.llama_pp.layer_weights.ds_load_utils import load_ds_weights
from lightllm.common.basemodel.layer_weights.hf_load_utils import load_hf_weights

from lightllm.models.llama.infer_struct import LlamaInferStateInfo
from lightllm.models.llama.splitfuse_infer_struct import LlamaSplitFuseInferStateInfo
from lightllm.common.basemodel import TpPpPartBaseModel
from lightllm.common.mem_utils import select_mem_manager_class
from lightllm.utils.log_utils import init_logger

logger = init_logger(__name__)

class LlamaTpPpPartModel(TpPpPartBaseModel):
    # weight class
    pre_and_post_weight_class = LlamaPpPreAndPostLayerWeight
    transformer_weight_class = LlamaPpTransformerLayerWeight

    # infer class
    pre_layer_infer_class = LlamaPpPreLayerInfer
    post_layer_infer_class = LlamaPpPostLayerInfer
    transformer_layer_infer_class = LlamaPpTransformerLayerInfer
    ...
    def _init_mem_manager(self):
        self.mem_manager = select_mem_manager_class(self.mode)(self.max_total_token_num, 
                                                     ...
                                                     layer_num=self.config["num_hidden_layers"] // self.nnodes)
        return
