...
from lightllm.models.llama.layer_infer.transformer_layer_infer import LlamaTransformerLayerInfer, LlamaTransformerLayerInferOffload
...
from lightllm.common.basemodel import TpPartBaseModel, TpPartOffloadModel
...
class LlamaTpPartOffloadModel(TpPartOffloadModel):
    # weight class
    pre_and_post_weight_class = LlamaPreAndPostLayerWeight
    transformer_weight_class = LlamaTransformerLayerWeight
    ...
    pre_layer_infer_class = LlamaPreLayerInfer
    post_layer_infer_class = LlamaPostLayerInfer
    transformer_layer_infer_class = LlamaTransformerLayerInferOffload

    # infer state class
    infer_state_class = LlamaInferStateInfo

    def __init__(self, tp_rank, world_size, weight_dir, max_total_token_num, load_way="HF", mode="", cache_num=-1):
        super().__init__(tp_rank, world_size, weight_dir, max_total_token_num, load_way, mode, cache_num)
    ...
    def _init_mem_manager(self):
        ...
        mem_manager_cls = mem_dict[self.mode]
