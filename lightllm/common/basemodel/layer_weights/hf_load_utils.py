...
def load_func(file_, tp_rank, use_safetensors=False, pre_post_layer=None, transformer_layer_list=None, weight_dir=None):
...
def load_hf_weights(data_type, weight_dir, tp_rank, pre_post_layer=None, transformer_layer_list=None, weight_dict=None):
    ...
    partial_func = partial(load_func, tp_rank=tp_rank, use_safetensors=use_safetensors, pre_post_layer=pre_post_layer, transformer_layer_list=transformer_layer_list, weight_dir=weight_dir)  # noqa
